/**
 * src/gather/places.ts
 *
 * Fetches Google Places (New API) data for the business.
 * Gracefully skips if GOOGLE_MAPS_API_KEY is not set.
 *
 * Uses the Places Text Search endpoint (v1) which requires the new Places API
 * to be enabled in the Google Cloud project.
 */

import { ENV } from "../config.js";
import type { PlacesResult, PlacesData } from "../types.js";
